...
The file comes with several quotations. You can also add your own. Each row
contains a quote, and a credit. The script will set the font size depending on
the length of the quote. Make sure your quotes aren't too long, or the text will
run off the edge of the screen! You can check the images generated by all quotes
using `tests/test-quotes.py`.
